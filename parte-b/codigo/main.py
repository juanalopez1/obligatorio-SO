...
logueado = psutil.Process().username().split('\\')[-1]
permitidos = ["Soporte", "Relaciones publicas", "Recepcion", "Contaduria", "juana"]
if logueado in permitidos:
    def menu():
        menu = (
    ...
    print("No tiene permisos de ejecución de este programa")